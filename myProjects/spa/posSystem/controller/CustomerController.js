...
function updateCustomer() {
    ...
    if (confirm("Do You Want To Update This Customer..? ")) {
        ...
        let searchCustomerId = $('#txtCustomerId').val();
        let searchCustomerIdIndex1 = searchCustomerIdIndex(searchCustomerId);
        customerDB[searchCustomerIdIndex1].id=newCusId;
        customerDB[searchCustomerIdIndex1].name=newCusName;
        customerDB[searchCustomerIdIndex1].address=newCusAddress;
        customerDB[searchCustomerIdIndex1].tp=newCusTp;
...
function deleteCustomer() {
    ...
    if (confirm("Do You Want To Delete This Customer..? ")) {
        ...
        // customerDB.pop();
        let searchCustomerId = $('#txtCustomerId').val();
        // console.log(searchItemCodeIndex(searchItemCode));
        customerDB[searchCustomerIdIndex(searchCustomerId)]=undefined;
...
function searchCustomerIdIndex(id) {
    for (let i = 0; i < customerDB.length; i++) {
        if (customerDB[i].id == id) {
            return i;
        }

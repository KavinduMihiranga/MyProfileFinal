...
function updateItem() {
    ...
    if (confirm("Do You Want To Update This Item..?")) {
        ...
        let searchItemCode = $('#txtItemCode').val();
        let searchItemCodeIndex1 = searchItemCodeIndex(searchItemCode);
        itemDB[searchItemCodeIndex1].code=newItemCode;
        itemDB[searchItemCodeIndex1].name=newItemName;
        itemDB[searchItemCodeIndex1].price=newItemPrice;
        itemDB[searchItemCodeIndex1].qty=newItemQty;
...
function deleteItem() {
    ...
    if (confirm("Do You Want To Delete This Item..? ")) {
        ...
        itemDB[searchItemCodeIndex(searchItemCode)]=undefined;
        $('#itemTable').display(loadAllItems());
...
function searchItemCodeIndex(code) {
